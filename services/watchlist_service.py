...
def add_to_watchlist(user_id, film_id, public=False):
    ...
    Args:
        ...
        public (bool): Whether the entry is publicly visible. Defaults to
            False (private) — callers opt in to sharing explicitly rather
            than inheriting a public default (see Comment 4 in pr-response.md).
